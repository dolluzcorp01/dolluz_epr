...
router.put  ("/competencies",                      ...auth, requireRole("super_admin"), ctrl.bulkUpdateCompetencies);
...
router.put  ("/:employee_id/unlock",               ...auth, requireRole("super_admin"), ctrl.unlockScore);
